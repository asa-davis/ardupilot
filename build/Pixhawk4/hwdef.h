...
#define HAL_USART6_CONFIG { (BaseSequentialStream*) &SD6, 6, false, STM32_USART6_RX_DMA_CONFIG, STM32_USART6_TX_DMA_CONFIG, 0, PAL_LINE(GPIOG,9U), PAL_LINE(GPIOG,8U), -1, 0, -1, 0}
